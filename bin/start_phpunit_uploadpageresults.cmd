...
call %BASEDIR%\bin\moodle-docker-compose exec webserver vendor/bin/phpunit %PHPUNITOPTIONS% tool_uploadpageresults_importer_testcase admin/tool/uploadpageresults/tests/importer_test.php
echo.
