...
call %BASEDIR%\bin\moodle-docker-compose exec webserver vendor/bin/phpunit %PHPUNITOPTIONS% mod_externalcontent_lib_testcase mod/externalcontent/tests/lib_test.php
echo.
...
call %BASEDIR%\bin\moodle-docker-compose exec webserver vendor/bin/phpunit %PHPUNITOPTIONS% mod_externalcontent_generator_testcase mod/externalcontent/tests/generator_test.php
echo.
...
call %BASEDIR%\bin\moodle-docker-compose exec webserver vendor/bin/phpunit %PHPUNITOPTIONS% mod_externalcontent_external_testcase mod/externalcontent/tests/externallib_test.php
echo.