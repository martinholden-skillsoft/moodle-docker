...
IF "%3"=="" ( SET "MOODLE_DOCKER_PHP_VERSION=7.4" ) ELSE ( SET "MOODLE_DOCKER_PHP_VERSION=%3" )
...
IF /I "%MOODLE_VERSION%"=="MOODLE_32_STABLE" SET MOODLE_SOLR=1
IF /I "%MOODLE_VERSION%"=="MOODLE_33_STABLE" SET MOODLE_SOLR=1
IF /I "%MOODLE_VERSION%"=="MOODLE_34_STABLE" SET MOODLE_SOLR=1
