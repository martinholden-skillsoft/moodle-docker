...
echo *** Moodle Upload Category Id: 99999
...
echo.
call %BASEDIR%\bin\moodle-docker-compose exec webserverdev php admin/tool/uploadexternalcontent/cli/uploadexternalcontent.php --source=../../../../%MOODLE_UPLOAD_FILE% -c=99999
echo.