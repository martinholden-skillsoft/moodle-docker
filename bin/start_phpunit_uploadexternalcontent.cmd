...
call %BASEDIR%\bin\moodle-docker-compose exec webserverdev vendor/bin/phpunit %PHPUNITOPTIONS% tool_uploadexternalcontent_importer_testcase admin/tool/uploadexternalcontent/tests/importer_test.php
echo.
