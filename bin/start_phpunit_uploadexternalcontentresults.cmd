...
call %BASEDIR%\bin\moodle-docker-compose exec webserver vendor/bin/phpunit %PHPUNITOPTIONS% tool_uploadexternalcontentresults_importer_testcase admin/tool/uploadexternalcontentresults/tests/importer_test.php
echo.
